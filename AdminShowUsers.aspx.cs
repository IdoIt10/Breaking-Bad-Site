...
public partial class AdminShowUsers : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       str = " <table border='1' id=\"tbl1\" name=\"tbl1\"><tr><th>Firstname</th><th>Lastname</th><th>Username</th><th>Password</th><th>Email</th><th>Phone</th><th>Select</th></tr>";

       string conStr = Session["ConnectionString"].ToString();
       string cmdStr = "SELECT  firstName, lastName, userName, password, email, phone  FROM TbUsers";
        ...
        if (Request.Form["sub"] != null)
        {
            ...
            else if (field1Value != "" && field2Value != "")
            {
                ...
                {
                    str = "<table border='1' id=\"tbl1\" name=\"tbl1\"><span style='color:red; font-weight:bold'>The two incisions must be different</span>";
                    continueFlag = false;
                }
            }
            else if (field1Value != "" && field2Value == "")
